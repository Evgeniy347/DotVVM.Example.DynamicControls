...
namespace WSSC.V4.SYS.DotVVMReference.Controls
{
    ...
    public class GridViewCheckBoxColumn2 : GridViewColumn
    {
        /// <summary>
        ...
        public static readonly DotvvmProperty ValueBindingProperty =
            DotvvmProperty.Register<bool, GridViewCheckBoxColumn2>(c => c.ValueBinding);
        ...
        public static readonly DotvvmProperty ValidatorPlacementProperty
            = DotvvmProperty.Register<ValidatorPlacement, GridViewCheckBoxColumn2>(c => c.ValidatorPlacement, default);
