...
{
    public abstract class GridViewColumn2 : DotvvmBindableObject
    {
        ...
        public static readonly DotvvmProperty HeaderTextProperty
            = DotvvmProperty.Register<string?, GridViewColumn2>(c => c.HeaderText, null);
        ...
        public static readonly DotvvmProperty HeaderTemplateProperty
            = DotvvmProperty.Register<ITemplate?, GridViewColumn2>(c => c.HeaderTemplate, null);
        ...
        public static readonly DotvvmProperty FilterTemplateProperty
            = DotvvmProperty.Register<ITemplate?, GridViewColumn2>(c => c.FilterTemplate, null);
        ...
        public static readonly DotvvmProperty SortExpressionProperty =
            DotvvmProperty.Register<string?, GridViewColumn2>(c => c.SortExpression);
        ...
        public static readonly DotvvmProperty SortAscendingHeaderCssClassProperty =
            DotvvmProperty.Register<string?, GridViewColumn2>(c => c.SortAscendingHeaderCssClass, "sort-asc");
        ...
        public static readonly DotvvmProperty SortDescendingHeaderCssClassProperty =
            DotvvmProperty.Register<string?, GridViewColumn2>(c => c.SortDescendingHeaderCssClass, "sort-desc");
        ...
        public static readonly DotvvmProperty AllowSortingProperty
            = DotvvmProperty.Register<bool, GridViewColumn2>(c => c.AllowSorting, false);
        ...
        public static readonly DotvvmProperty CssClassProperty =
            DotvvmProperty.Register<string?, GridViewColumn2>(c => c.CssClass);
        ...
        public static readonly DotvvmProperty IsEditableProperty =
            DotvvmProperty.Register<bool, GridViewColumn2>(t => t.IsEditable, true);
        ...
        public static readonly DotvvmProperty HeaderCssClassProperty =
            DotvvmProperty.Register<string?, GridViewColumn2>(c => c.HeaderCssClass);
        ...
        public static readonly DotvvmProperty WidthProperty
            = DotvvmProperty.Register<string?, GridViewColumn2>(c => c.Width, null);
        ...
        public static readonly DotvvmProperty VisibleProperty
            = DotvvmProperty.Register<bool, GridViewColumn2>(c => c.Visible, true);
        ...
        public static readonly DotvvmProperty CellDecoratorsProperty =
            DotvvmProperty.Register<List<Decorator>?, GridViewColumn2>(c => c.CellDecorators);
        ...
        public static readonly DotvvmProperty EditCellDecoratorsProperty =
            DotvvmProperty.Register<List<Decorator>?, GridViewColumn2>(c => c.EditCellDecorators);
        ...
        public static readonly DotvvmProperty HeaderCellDecoratorsProperty =
            DotvvmProperty.Register<List<Decorator>?, GridViewColumn2>(c => c.HeaderCellDecorators);
        ...
        public virtual void CreateHeaderControls(IDotvvmRequestContext context, GridView2 gridView, Action<string?>? sortCommand, HtmlGenericControl cell, IGridViewDataSet? gridViewDataSet)
        {
            ...
            if (AllowSorting)
            {
                ...
                SetSortedCssClass(cell, gridViewDataSet, gridView.GetValueBinding(GridView2.DataSourceProperty)!);
            }
            else
            {
        ...
        public virtual void CreateFilterControls(IDotvvmRequestContext context, GridView2 gridView, HtmlGenericControl cell, ISortableGridViewDataSet? sortableGridViewDataSet)
        {
        ...
        public static IEnumerable<ControlUsageError> ValidateUsage(ResolvedControl control)
        {
            ...
            {
                yield return new ControlUsageError("Changing the DataContext property on the GridViewColumn2 is not supported!", control.DothtmlNode);
            }
            ...
            foreach (var property in control.Properties)
            {
                ...
                if (!typeof(GridViewColumn2).IsAssignableFrom(property.Key.DeclaringType))
                {
