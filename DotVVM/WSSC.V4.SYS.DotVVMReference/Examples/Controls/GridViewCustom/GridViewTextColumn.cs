...
namespace WSSC.V4.SYS.DotVVMReference.Controls
{
    ...
    public class GridViewTextColumn2 : GridViewColumn2
    {
        public GridViewTextColumn2()
        { 
        ...
        public static readonly DotvvmProperty FormatStringProperty
            = DotvvmProperty.Register<string?, GridViewTextColumn2>(c => c.FormatString, null);
        ...
        public static readonly DotvvmProperty ChangedBindingProperty =
            DotvvmProperty.Register<ICommandBinding?, GridViewTextColumn2>(t => t.ChangedBinding, null);
        ...
        public static readonly DotvvmProperty ValueBindingProperty =
            DotvvmProperty.Register<IValueBinding?, GridViewTextColumn2>(c => c.ValueBinding);
        ...
        public static readonly DotvvmProperty ValidatorPlacementProperty
            = DotvvmProperty.Register<ValidatorPlacement, GridViewTextColumn2>(c => c.ValidatorPlacement, default);
