...
namespace WSSC.V4.SYS.DotVVMReference.Examples
{
    public class DotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator
    {
        public void Configure(DotvvmConfiguration config, string applicationPath)
        {
            if (Directory.Exists("C:\\Users\\GTR\\Desktop\\По работе\\DotVVM\\WSSC.V4.SYS.DotVVMReferenceCross"))
                config.ApplicationPhysicalPath = "C:\\Users\\GTR\\Desktop\\По работе\\DotVVM\\WSSC.V4.SYS.DotVVMReferenceCross";
            else
                config.ApplicationPhysicalPath = "C:\\testapp\\wwwcore";
        ...
        private void ConfigureRoutes(DotvvmConfiguration config, string applicationPath)
        {
            ...
            config.RouteTable.Add("Examples/Defaulte", "", "Examples/Views/Example_7_RenderControl.dothtml");
        ...
        private void ConfigureControls(DotvvmConfiguration config, string applicationPath)
        {
            ...
            //config.Markup.AddCodeControls("cc", typeof(WSSC.V4.SYS.DotVVMReference.Controls.GridView2));
