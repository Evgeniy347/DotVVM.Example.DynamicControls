...
namespace WSSC.V4.SYS.DotVVMReference
{
    ...
    {
        public CustomControlTreeResolver(IControlResolver controlResolver, IControlBuilderFactory controlBuilderFactory, IAbstractTreeBuilder treeBuilder, DotvvmResourceRepository resourceRepo) : base(controlResolver, controlBuilderFactory, treeBuilder, resourceRepo)
        {
        }
