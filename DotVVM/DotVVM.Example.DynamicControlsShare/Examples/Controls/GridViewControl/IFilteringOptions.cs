...
namespace DotVVM.BusinessPack.Controls
{
    //
    // Сводка:
    //     Represents settings for filtering.
    public interface IFilteringOptions
    {
        //
        // Сводка:
        //     Gets or sets the group of filters applied to data source.
        FilterGroup FilterGroup { get; set; }
    }
}
