...
namespace WSSC.V4.SYS.DotVVMReference.Controls
{
    ...
    public class GridView2 : ItemsControl
    {
        private EmptyData? emptyDataContainer;
        private int numberOfRows;
        private HtmlGenericControl? head;

        public GridView2() : base("table")
        {
            SetValue(Internal.IsNamingContainerProperty, true);

            Columns = new List<GridViewColumn2>();
            RowDecorators = new List<Decorator>();

            if (GetType() == typeof(GridView2))
        ...
        public static readonly DotvvmProperty FilterPlacementProperty
            = DotvvmProperty.Register<GridViewFilterPlacement, GridView2>(c => c.FilterPlacement, GridViewFilterPlacement.HeaderRow);
        ...
        public static readonly DotvvmProperty EmptyDataTemplateProperty =
            DotvvmProperty.Register<ITemplate?, GridView2>(t => t.EmptyDataTemplate, null);
        ...
        public List<GridViewColumn2>? Columns
        {
            get { return (List<GridViewColumn2>?)GetValue(ColumnsProperty); }
            set { SetValue(ColumnsProperty, value); }
        }
        public static readonly DotvvmProperty ColumnsProperty =
            DotvvmProperty.Register<List<GridViewColumn2>, GridView2>(c => c.Columns);
        ...
        public static readonly DotvvmProperty RowDecoratorsProperty =
            DotvvmProperty.Register<List<Decorator>?, GridView2>(c => c.RowDecorators);
        ...
        public static readonly DotvvmProperty HeaderRowDecoratorsProperty =
            DotvvmProperty.Register<List<Decorator>?, GridView2>(c => c.HeaderRowDecorators);
        ...
        public static readonly DotvvmProperty EditRowDecoratorsProperty =
            DotvvmProperty.Register<List<Decorator>?, GridView2>(c => c.EditRowDecorators);
        ...
        public static readonly DotvvmProperty SortChangedProperty =
            DotvvmProperty.Register<Action<string>?, GridView2>(c => c.SortChanged, null);
        ...
        public static readonly DotvvmProperty ShowHeaderWhenNoDataProperty =
            DotvvmProperty.Register<bool, GridView2>(t => t.ShowHeaderWhenNoData, false);
        ...
        public static readonly DotvvmProperty InlineEditingProperty =
            DotvvmProperty.Register<bool, GridView2>(t => t.InlineEditing, false);
        ...
        private static void SetCellAttributes(GridViewColumn2 column, HtmlGenericControl cell, bool isHeaderCell)
        {
            ...
            if (!isHeaderCell)
            {
                var cssClassBinding = column.GetValueBinding(GridViewColumn2.CssClassProperty);
            ...
            {
                if (column.IsPropertySet(GridViewColumn2.VisibleProperty)) cell.SetValue(TableUtils.ColumnVisibleProperty, GridViewColumn2.VisibleProperty.GetValue(column));
                if (column.IsPropertySet(GridViewColumn2.HeaderCssClassProperty)) // transfer all bindings (even StaticValue), because column has wrong DataContext for them
                {
                    cellAttributes["class"] = column.GetValueRaw(GridViewColumn2.HeaderCssClassProperty);
                }
            }
        }
        ...
        private PropertyInfo ResolvePrimaryKeyProperty()
        {
            ...
            if (string.IsNullOrEmpty(primaryKeyPropertyName))
            {
                throw new DotvvmControlException(this, $"The {nameof(IGridViewDataSet)} must " +
                    ...
                    $"when inline editing is enabled on the {nameof(GridView2)} control!");
            }
        ...
        public override IEnumerable<DotvvmBindableObject> GetLogicalChildren()
        {
            return base.GetLogicalChildren().Concat(
                Columns ?? Enumerable.Empty<GridViewColumn2>()
            ).Concat(
