...
namespace WSSC.V4.SYS.DotVVMReference.Examples
{
    public class DotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator
    {
        ...
        {
            if (Directory.Exists("C:\\Users\\GTR\\Desktop\\По работе\\DotVVM\\WSSC.V4.SYS.DotVVMReference"))
                config.ApplicationPhysicalPath = "C:\\Users\\GTR\\Desktop\\По работе\\DotVVM\\WSSC.V4.SYS.DotVVMReference";
            else
                config.ApplicationPhysicalPath = "C:\\testapp\\www\\WSSC.V4.SYS.DotVVMReference";
